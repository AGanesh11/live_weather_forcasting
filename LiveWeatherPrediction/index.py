...
api_key = "a1b7faa1272940d79bb74535250504"  # Replace with your API key
...
location_input = st.text_input("📍 Enter Location", value="Kumbakonam")
...
def send_msg(condition,location):
    try:
        site = "https://liveweatherforecasting.streamlit.app/"
        account_sid = "AC8c07d312f756ac8492630d328b17875c"
        auth_token = "3a5217dcb24fb1dad498530d8d1822cb"
        twilio_number = "+17603097698"  # Replace with your Twilio number
        to_number = "+917092639244"     # Your verified number
        ...
        message = client.messages.create(
            body=message_body+"\n Location : "+location+" learn more "+ site,
            from_=twilio_number,
            to=to_number
        )
